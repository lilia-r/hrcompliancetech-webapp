...
/**
 * dashboard-rh.php
 * Tableau de bord RH et Juristes.
 * Accès réservé aux rôles 'rh' et 'juriste'.
 */
...
logAudit('CONSULTATION_TABLEAU_BORD', 'Acces au tableau de bord RH');
?>
<!DOCTYPE html>
<html lang="fr">
<head>
    ...
    <title>HRComplianceTech – Tableau de bord RH</title>
    ...
    <nav class="navbar site-navbar" aria-label="Navigation principale">
        <div class="container-fluid px-4">
            ...
            <div class="d-flex align-items-center gap-3">
                <a href="../dashboards/dashboard-rh.php" class="nav-link nav-link-custom">Tableau de bord</a>
    ...
    <main class="dashboard-main">
        <div class="container-fluid px-4">
            ...
            <header class="dashboard-entete">
                <div>
                    <p class="dashboard-sous-titre" style="margin-bottom:0.25rem;">Mon espace RH</p>
            ...
            <div class="filtres-barre">
                ...
                <div class="filtre-groupe">
                    ...
                    <select id="filtre-tri-date" class="filtre-select"
                            onchange="window.location.href='dashboard-rh.php?tri_date='+this.value">
                                ...
                                <td class="col-declarant">
                                    ...
                                    <?php else: ?>
                                        ...
                                        <?= $nomComplet
                                            ...
                                            : '<em style="color:var(--gris-texte)">Non renseigné</em>'
                                        ?>
